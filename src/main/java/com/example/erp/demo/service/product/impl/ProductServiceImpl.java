...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceImpl(ProductRepository productRepository, ProductMapper productMapper, LicenseRepository licenseRepository) {
    ...
    public ProductResponseDto getProductByLicenseKey(String licenseKey) {
        return productMapper.toProductDtoFromProductEntity(
